     ...
     Now we can use the MessageWrapperW# React Interview Questions & Answers

> Click :star:if you like the project. Pull Request are highly appreciated. Follow me [@Sathya vilber sahan](https://www.linkedin.com/in/sathya-vilber-sahan/) for technical updates.
...
> 💡 Nail React interviews with questions and solutions from ex-interviewers! [Try GreatFrontEnd →](https://www.linkedin.com/in/sathya-vilber-sahan/) 💡
...
242. ### What is a wrapper component?
     ...
     const MessageWrapperWithTitle = ({ title, ...props }) => {
       return (
         <div>
           <h3>{title}</h3>ithTitle component and pass title props:
